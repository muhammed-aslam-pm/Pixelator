...
import 'package:pixelator/presentation/pages/case_detail_page.dart';
...
class CasesTable extends StatelessWidget {
  ...
  Widget _buildMobileList() {
    ...
    return Column(
      children: cases
          .map((caseEntity) => _CaseCard(caseEntity: caseEntity))
          .toList(),
    );
  }
                ...
                DataCell(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) =>
                            CaseDetailPage(caseId: caseEntity.caseId),
                      ),
                    );
                  },
                  Text(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => CaseDetailPage(caseId: caseEntity.caseId),
          ),
        );
      },
      child: Container(
